...
interface LotsRepository {
    ...
    suspend fun createLot(categoryId: Int, title: String, description: String?, price: Double, quantity: Int): Result<Lot>
    suspend fun updateLot(id: String, title: String?, description: String?, price: Double?, quantity: Int?, status: String?): Result<Lot>
